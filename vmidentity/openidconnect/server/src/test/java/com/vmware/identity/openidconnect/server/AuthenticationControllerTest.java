...
public class AuthenticationControllerTest {
    ...
    @Test
    public void testAuthzCodeFlowResponseModeBlank() throws Exception {
        Flow flow = Flow.AUTHZ_CODE;
        Map<String, String> params = authnRequestParameters(flow);
    ...
    public void testImplicitFlowClientAssertionInvalidAudience() throws Exception {
        ...
        assertErrorResponse(flow, params, "invalid_client", "assertion audience does not match request URL");
    }
    ...
    public void testImplicitFlowClientAssertionStale() throws Exception {
        ...
        Map<String, String> params = authnRequestParameters(flow);
        JWTClaimsSet clientAssertionClaims = clientAssertionClaims();
        Date issuedAt = new Date(clientAssertionClaims.getIssueTime().getTime() - (2 * 60 * 60 * 1000L)); // issued 2 hrs ago
