...
public class AuthorizationCodeFlowTest {
    ...
    public static void setup() throws Exception {
        initialize();
        AuthorizationCodeFlowTest.POST_LOGOUT_REDIRECT_URI = new URI("https://relyingparty.com/postlogout");
        AuthorizationCodeFlowTest.LOGOUT_URI = new URI("https://relyingparty.com/logout");
    }
    ...
    public void test() throws Exception {
        ...
        IdmClient idmClient = idmClientBuilder().additionalClient(client).build();
    ...
    private static String[] doAuthnRequest(
        ...
        clientAssertionClaims.setIssuer(AuthorizationCodeFlowTest.CLIENT_ID);
        clientAssertionClaims.setSubject(AuthorizationCodeFlowTest.CLIENT_ID);
