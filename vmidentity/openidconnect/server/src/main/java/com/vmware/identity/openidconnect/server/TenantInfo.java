...
public class TenantInfo {
    ...
    public static class AuthnPolicy {
        private final boolean allowPasswordAuthn;
        private final boolean allowWindowsSessionAuthn;

        public AuthnPolicy(
                boolean allowPasswordAuthn,
                boolean allowWindowsSessionAuthn) {
            this.allowPasswordAuthn = allowPasswordAuthn;
            this.allowWindowsSessionAuthn = allowWindowsSessionAuthn;
        }

        public boolean getAllowPasswordAuthn() {
            return this.allowPasswordAuthn;
        }

        public boolean getAllowWindowsSessionAuthn() {
            return this.allowWindowsSessionAuthn;
        }
    }
}