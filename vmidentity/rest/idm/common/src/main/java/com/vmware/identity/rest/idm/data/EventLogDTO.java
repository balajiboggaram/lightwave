...
public class EventLogDTO extends DTO {
    ...
    /**
     * Construct a {@code EventLogDTO} with its event type, correlation ID, outcome,
     ...
     */
    public EventLogDTO(String type, String correlationId, String outcome,
...
System.currentTimeMillis();
     ...
     *
     * @return a new {@code DiagnosticLogDTO.Builder}.
     */
    ...
    public static class Builder {
        ...
        public EventLogDTO build() {
            return new EventLogDTO(type, correlationId, outcome, start, elapsedMillis, metadata);
        }
    }
